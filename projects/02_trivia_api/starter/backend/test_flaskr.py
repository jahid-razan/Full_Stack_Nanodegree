...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_create_questions(self):
        ...
        new_question =  {'question': "Which 03 countries will host 2026 football worlcup?", 
    ...
    def test_quizzes(self):
        ...
        details = {'quiz_category': {'id':2},
                   'pevious_questions': ['La Giaconda is better known as what?']
                 }  
